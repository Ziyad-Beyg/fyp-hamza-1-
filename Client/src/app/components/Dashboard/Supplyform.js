    ...
    >
      <Box
        ...
        <FormControl sx={{ marginY: 1, width: "100%" }}>
          ...
          <TextField label="Supplier ID" variant="outlined" type="text"
            {...register('email', {
        ...
        <FormControl sx={{marginY: 1}} fullWidth>
                    <TextField fullWidth label="Supplier Name" variant="outlined" type="text" 
        ...
        <FormControl sx={{marginY: 1}} fullWidth>
                    <TextField fullWidth label="Supplier Address" variant="outlined" type="text" InputProps={{ disableUnderline: true }}
        ...
        <FormControl fullWidth>
                    <TextField fullWidth label="Supplier Phone" variant="outlined" type="number" InputProps={{ disableUnderline: true }}
